...
class TestIsExpiryDay:
    ...
    @pytest.mark.parametrize("third_friday", [
        "2024-01-19", "2024-02-16", "2024-03-15",
        "2024-04-19", "2024-05-17", "2024-06-21",
        "2024-07-19", "2024-08-16", "2024-09-20",
        "2024-10-18", "2024-11-15", "2024-12-20",
    ])
    ...
    @pytest.mark.parametrize("not_expiry", [
    ...
    @pytest.mark.parametrize("non_friday", [
        "2024-01-15",  # Monday
        "2024-01-16",  # Tuesday
        "2024-01-17",  # Wednesday
        "2024-01-18",  # Thursday
